...
def jsonify_checkpoint(checkpoint_path):
...
def jsonify_checkpoints_in_folder(folder_path, output_path):
...
if __name__ == "__main__":
    ...
    if os.path.isdir(checkpoint_path):
        ...
        jsonify_checkpoints_in_folder(checkpoint_path, output_path)
    else:
        ...
        checkpoint = jsonify_checkpoint(checkpoint_path)
        if output_file != "":
